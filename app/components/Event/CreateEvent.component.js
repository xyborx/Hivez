...
import styles from './CreateEvent.component.style';
			...
			<ScrollView keyboardShouldPersistTaps={'handled'} showsVerticalScrollIndicator={false} style={styles.pageContainer} contentContainerStyle={styles.pageContentView}>
				...
				<View style={styles.pageContentView}>
					...
					<PreviewPicture
						...
						<Image
							source={props.image === '' ? require('../../assets/images/DefaultEventImage.png') : {uri: `data:image/jpeg;base64,${props.image}`}}
							style={styles.eventImage} />
					</PreviewPicture>
					<View style={styles.createEventContainer}>
						<TextField
							contentText={props.eventNameText}
							customValidateInput={props.validateName}
							onChangeText={props.setName}
							placeholder={props.contentText['EVENT_NAME_PLACEHOLDER']}
						...
						<TextField
							...
							placeholder={props.contentText['EVENT_DESCRIPTION_PLACEHOLDER']}
							style={styles.textField}
						...
						<View style={props.image === '' ? styles.noPreview : styles.pictureConfigContainer}>
							<PreviewPicture
								...
								<View style={styles.viewImage}>
									...
									<Text style={styles.viewImageText}>{props.contentText['VIEW_EVENT_PICTURE']}</Text>
								</View>
							</PreviewPicture>
							<DropdownChangePicture
								...
								<ButtonWithIcon
									...
									icon={'camera'}
									onPress={() => {}}
									text={props.image === '' ? props.contentText['ADD_EVENT_PICTURE'] : props.contentText['EDIT_EVENT_PICTURE']} />
							</DropdownChangePicture>
						</View>
						<ButtonWithConfirmation
							...
							style={styles.button}
							text={props.contentText['CREATE_EVENT']} />
					</View>
				</View>
			</ScrollView>
		</SafeAreaView>
