            ...
            <Overlay {...overlayProps}>
                <View style={[styles.overlayStyle, this.props.overlayStyle]}>
                    ...
                    <View style={[styles.cancelContainer, this.props.cancelContainerStyle]}>
                        <TouchableHighlight onPress={this.close} activeOpacity={this.props.touchableActiveOpacity} accessible={this.props.cancelButtonAccessible} accessibilityLabel={this.props.cancelButtonAccessibilityLabel} underlayColor={'rgba(0,0,0,0.05)'}>
