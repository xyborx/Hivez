...
import GroupBillPayment from '../components/Bill/GroupBillPayment.component';
...
const GroupBillPaymentPage = ({route, navigation}) => {
	...
	const payBill = () => {
		...
		alert(`Paying bill: ${billID} with date: ${formattedDate}, time: ${formattedTime}`);
	};
